...
export default function AdminTicketCard({ handleUpdateStatus, handleDeleteTicket, ticket, setSelectedTicketId }) {
    return (
        <motion.div
            ...
            <div className="text-center sm:col-span-2 md:col-span-1">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <motion.button
                        ...
                        className="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition duration-300 transform"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                    >
                        Reply 💬
